...
ThinLineWidth = 4
ThickLineWidth = 6
WindowWidth = (CellsX  + 4) * CellSize + (ThinLineWidth / 2)
WindowHeight = (CellsY + 2) * CellSize + (ThinLineWidth / 2)
...
class Interface:
	...
	def drawGrid(self):
		for x in range(0, WindowWidth, CellSize):
			pygame.draw.line(self.DisplayScreen, LightGray, (x, 0), (x, WindowHeight), ThinLineWidth)
		for y in range(0, WindowHeight, CellSize):
			pygame.draw.line(self.DisplayScreen, LightGray, (0, y), (WindowWidth, y), ThinLineWidth)

		for x in range(CellSize, WindowWidth, CellSize * 3):
			pygame.draw.line(self.DisplayScreen, Black, (x, 0), (x, WindowHeight), ThickLineWidth)
		for y in range(CellSize, WindowHeight, CellSize * 3):
			pygame.draw.line(self.DisplayScreen, Black, (0, y), (WindowWidth, y), ThickLineWidth)
